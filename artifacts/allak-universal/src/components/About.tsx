      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-brand-teal translate-x-4 translate-y-4 rtl:-translate-x-4 -z-10"></div>
            <img
              src={aboutOffice}
            ...
            <div className="absolute -bottom-8 start-[-2rem] bg-brand-navy text-brand-cream p-6 md:p-8 max-w-[280px] shadow-2xl hidden md:block">
              <p className="text-4xl font-serif font-bold text-brand-teal mb-2">{t.badgeCountry}</p>
              <p className="text-sm text-brand-cream/70 font-medium tracking-wide uppercase">{t.badgeSubtitle}</p>
            </div>
          </div>
